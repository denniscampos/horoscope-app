  ...
  fetch(URL, {
    ...
    .then((json) => {
      ...
      return sign === "aries"
        ...
        ? (document.querySelector("#img__print").src = "img/gemini.png")
        : sign === "taurus"
        ? (document.querySelector("#img__print").src = "img/taurus.png")
        : sign === "cancer"
        ? (document.querySelector("#img__print").src = "img/cancer.png")
        : sign === "leo"
        ? (document.querySelector("#img__print").src = "img/leo.png")
        : sign === "virgo"
        ? (document.querySelector("#img__print").src = "img/virgo.png")
        : sign === "libra"
        ? (document.querySelector("#img__print").src = "img/libra.png")
        : sign === "scorpio"
        ? (document.querySelector("#img__print").src = "img/scorpio.png")
        : sign === "sagittarius"
        ? (document.querySelector("#img__print").src = "img/sagittarius.png")
        : sign === "capricorn"
        ? (document.querySelector("#img__print").src = "img/capricorn.png")
        : sign === "aquarius"
        ? (document.querySelector("#img__print").src = "img/aquarius.png")
        : sign === "pisces"
        ? (document.querySelector("#img__print").src = "img/pisces.png")
        : console.log("nothing");
    });
}
